...
<div class="container-fluid">
    ...
    <div class="row justify-content-start mt-3">
      ...
      <div class="col-md-4 mb-md-3">
        <a href="/buku/{{ $book->key }}/pemasukan/tambah" class="btn btn-success" style="width:">
                    ...
                    <div class="modal-body">
                      <form action="/flow/{{ $flow->id }}" method="post">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="name" aria-describedby="nama" name="name" required placeholder="Cth. Gaji Bulanan" value="{{ $flow->name }}" required> 
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="desc" name="desc" placeholder="Cth. Gaji pokok" value="{{ $flow->desc }}">
