    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          ...
          <main class="form-login text-start p-4">
            <form action="/register" method="post">
              @csrf
              <div class="text-center">
                <h1 class="d-inline-block mb-2">DaMoney</h1>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control border-dark bg-transparent" required id="name" name="name">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <div id="descHelpBlock" class="form-text">
                  Kata sandi paling sedikit terdiri dari 6 karakter bebas
              </div>
              </div>
              <div class="mb-3">
                <label for="passwordconfirm" class="form-label">Konfirmasi Kata Sandi</label>
                <input type="password" required class="form-control border-dark bg-transparent @error('password_confirm') is_invalid @enderror" name="password_confirm" id="passwordconfirm">
              ...
              <p class="mt-2">Sudah Terdaftar? Masuk<a href="/login" class="text-dark"> di sini</a></p>
            </form>
          </main>
